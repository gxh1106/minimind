...
# CUDA_VISIBLE_DEVICES=1,2,3 torchrun --nproc_per_node 3 train_full_sft.py --epochs 5 --attn_gate 1 --use_wandb --data_path ../dataset/sft_t2t.jsonl --max_seq_len 1500 --batch_size 96 --learning_rate 5e-5
if __name__ == "__main__":
    ...
    lm_config = MiniMindConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe), elementwise_attn_output_gate=(args.attn_gate == 1), headwise_attn_output_gate=(args.attn_gate == 2))
