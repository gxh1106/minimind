...
class MiniMindConfig(PretrainedConfig):
    ...
    def __init__(self, hidden_size=768, num_hidden_layers=8, use_moe=False, **kwargs):
        ...
        self.elementwise_attn_output_gate = kwargs.get("elementwise_attn_output_gate", False)
        self.headwise_attn_output_gate = kwargs.get("headwise_attn_output_gate", False)
...
class Attention(nn.Module):
    def __init__(self, config: MiniMindConfig):
        ...
        if self.headwise_attn_output_gate:
            self.q_proj = nn.Linear(config.hidden_size, config.num_attention_heads * self.head_dim + config.num_attention_heads, bias=False)
